        ...
        <div class="row">
            <div class="col-md-3">
                <div class="user-info border rounded mt-4 d-flex flex-column align-items-center p-3">
                    ...
                    <img src="https://minotar.net/avatar/{{ $name }}/100" alt="{{ $name }}" style="max-width: 140px;" class="rounded">
                    ...
                    <table class="table table-striped table-hover mt-4">
                        ...
                        @forelse ($bans as $item)
                            <tr class="text-nowrap">
                                ...
                                @if ($issued)
                                    <td>
                                        <img src="https://minotar.net/avatar/{{ $item->name }}/25" alt="{{ $item->name }}">
                                        {{ $item->name }}
                                    </td>
                                @else
                                    <td>
                                        <img src="https://minotar.net/avatar/{{ $item->banned_by_name }}/25" alt="{{ $item->banned_by_name }}">
                                        {{ $item->banned_by_name }}
                                    </td>
                                @endif
