...
use Azuriom\Plugin\Litebans\Models\Kicks;

class LitebansKickController extends Controller
{
 /**
 ...
 public function index()
 {
  try {
   ...
   return view('litebans::kick', ['kicksList' => Kicks::getKicksList()]);
  } catch (\PDOException $e) {
   return view('litebans::error');
  }

  return view('litebans::kick');
 }
}
