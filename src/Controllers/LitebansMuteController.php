...
use Azuriom\Plugin\Litebans\Models\Mutes;

class LitebansMuteController extends Controller
{
 /**
 ...
 public function index()
 {
  try {
   ...
   return view('litebans::mute', ['mutesList' => Mutes::getMutesList()]);
  } catch (\PDOException $e) {
   return view('litebans::error');
  }

  return view('litebans::mute');
 }
}
